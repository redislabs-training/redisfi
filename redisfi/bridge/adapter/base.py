...
from redisfi.db import index_bar, index_asset, index_transaction, index_asset_portfolio_value
...
class BaseAdapter:
    def __init__(self, cli: Command, assets: list, crypto: list, redis_url: str, **kwargs) -> None:
        ...
        self.indexes = [index_bar, index_asset, index_transaction, index_asset_portfolio_value]
